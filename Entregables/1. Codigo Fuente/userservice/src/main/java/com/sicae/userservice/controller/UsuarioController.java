...
public class UsuarioController {
    ...
    @PostMapping("/agregar")
    public ResponseEntity<?> agregarNuevoUsuario(@RequestHeader("Authorization") String tokenR,@RequestBody UsuariosRequestDTO nuevoUsuario) {
        ...
        try {
            ...
            String tokenPuro = tokenR.substring(7);
   ...
   // Este es nuestro segundo endpoint chicos. Sirve para editar algun usuario.
    ...
    public ResponseEntity<?> editarUsuario(@RequestHeader("Authorization") String tokenR, @PathVariable Integer idUsuario, @RequestBody UsuariosRequestDTO nuevoUsuario) {
    ...
    public ResponseEntity<?> verPerfil(@RequestHeader("Authorization") String tokenR,@PathVariable Integer idUsuario) {
    ...
    public ResponseEntity<?> actualizarEstatus(@RequestHeader("Authorization") String tokenR,@PathVariable Integer idUsuario, @PathVariable Integer idRol) {
